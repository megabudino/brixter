	...
	function defineThemes(monaco: typeof import('monaco-editor')) {
		monaco.editor.defineTheme('brixter-dark', {
			...
			colors: {
				...
				'editor.lineHighlightBackground': '#2d2a2580',
				'editor.selectionBackground': '#FDE04740',
				'editorLineNumber.foreground': '#6B7280',
				'editorLineNumber.activeForeground': '#D1D5DB',
				'editorCursor.foreground': '#FDE047',
				'editor.selectionHighlightBackground': '#FDE04720',
				'editorIndentGuide.background': '#2d2a25',
				'editorIndentGuide.activeBackground': '#444039',
				'editorWidget.background': '#2d2a25',
				'editorWidget.border': '#444039',
				'input.background': '#2d2a25',
				'input.border': '#444039',
			}
		});
		...
		monaco.editor.defineTheme('brixter-light', {
			...
			colors: {
				...
				'editor.selectionBackground': '#FDE04730',
				'editorLineNumber.foreground': '#9CA3AF',
				'editorLineNumber.activeForeground': '#4B5563',
				'editorCursor.foreground': '#FDE047',
				'editor.selectionHighlightBackground': '#FDE04715',
